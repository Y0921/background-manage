  ...
  <el-card shadow="never" class="border-0">
    ...
    >
      <template #default="{ data }">
        <div class="custom-tree-node">
          <el-tag size="small" effect="dark" :type="data.menu ? '' : 'info'">
            {{ data.menu ? "菜单" : "权限" }}
          </el-tag>
    ...
    <FormDraw ref="FormDrawerRef" :title="DrawerTitle" @submit="handleSubmit">
      ...
      >
        ...
        <el-form-item label="前端路由" prop="frontpath" v-if="form.menu == 0">
          <el-input v-model="form.frontpath"></el-input>
        </el-form-item>

        <el-form-item label="后端路由" prop="condition" v-if="form.menu == 0">
